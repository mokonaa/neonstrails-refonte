...
// animationFadeOut(closeButton);
// allLinksNavbar.forEach((link) => {
//     animationFadeIn(link);
// })
function animationFadeIn(elementClicked) {
...
function animationFadeOut(elementClicked) {
    elementClicked.addEventListener("click", ()=>{
 ...
 */ new WOW().init(); // disable the scroll event for the time the loading is done
...
},{}]},["4tgfT","dV6cC"], "dV6cC", "parcelRequireaaab")
